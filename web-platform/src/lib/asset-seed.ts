...
const CRYPTO: Array<Omit<SeedAsset, "category" | "signalTier" | "provider" | "providerSymbol"> & {
  ...
  { symbol: "Bitcoin OTC", displaySymbol: "Bitcoin (BTC)", isOtc: true, payoutPct: 92 },
  { symbol: "Litecoin OTC", displaySymbol: "Litecoin (LTC)", isOtc: true, payoutPct: 92 },
  { symbol: "Dogecoin OTC", displaySymbol: "Dogecoin (DOGE)", isOtc: true, payoutPct: 83 },
  { symbol: "Polygon OTC", displaySymbol: "Polygon (MATIC)", isOtc: true, payoutPct: 83 },
  { symbol: "Cardano OTC", displaySymbol: "Cardano (ADA)", isOtc: true, payoutPct: 74 },
  { symbol: "Polkadot OTC", displaySymbol: "Polkadot (DOT)", isOtc: true, payoutPct: 74 },
  { symbol: "Chainlink OTC", displaySymbol: "Chainlink (LINK)", isOtc: true, payoutPct: 71 },
  { symbol: "BNB OTC", displaySymbol: "BNB", isOtc: true, payoutPct: 69 },
  { symbol: "Avalanche OTC", displaySymbol: "Avalanche (AVAX)", isOtc: true, payoutPct: 53 },
  { symbol: "Solana OTC", displaySymbol: "Solana (SOL)", isOtc: true, payoutPct: 49 },
  { symbol: "TRON OTC", displaySymbol: "TRON (TRX)", isOtc: true, payoutPct: 44 },
  { symbol: "Ethereum OTC", displaySymbol: "Ethereum (ETH)", isOtc: true, payoutPct: 37 },
  { symbol: "Toncoin OTC", displaySymbol: "Toncoin (TON)", isOtc: true, payoutPct: 20 },
