...
const FALLBACK_FAQS = [
  ...
  },
  {
    ...
    a: "Нет. Депозит не обязателен — достаточно зарегистрироваться на PocketOption по нашей ссылке. Бесплатный уровень: 3 OTC-сигнала в день. От $20 — Базовый (10 сигналов, OTC + биржа). От $100 — Про (безлимит, все типы + аналитика).",
  },
  {
  ...
  },
  {
    ...
    a: "Зарегистрируйся на PocketOption по нашей ссылке — откроется Бесплатный уровень. Внеси депозит от $20 — поднимешься до Базового. От $100 — автоматически Про.",
  },
];
