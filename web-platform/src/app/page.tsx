...
const FALLBACK_FAQS = [
  {
    q: "Это бесплатно?",
    a: "Да. Signal Trade GPT не берёт подписок. Доступ открывается регистрацией на PocketOption по нашей ссылке. Мы зарабатываем на партнёрке — поэтому заинтересованы в качестве сигналов.",
  },
  {
  ...
  },
  {
    ...
    a: "Нет. Signal Trade GPT не является финансовым советником. Все сигналы — информационные. Торговля бинарными опционами сопряжена с высоким риском.",
  },
];
