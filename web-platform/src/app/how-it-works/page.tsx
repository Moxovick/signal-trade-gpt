...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Сразу после привязки PO доступен Обычный уровень: безлимит OTC-сигналов 24/7, личный кабинет, бот. С первым депозитом ≥ $20 открывается Про: все типы сигналов (OTC + биржа + Elite), индикаторы и аналитика.",
  },
  {
    n: "04",
    icon: Bot,
...
const TIERS = [
  {
    ...
    name: "Обычный",
    deposit: "$0",
    desc: "Для всех, кто зарегистрировался на PocketOption по нашей ссылке. Безлимит OTC-сигналов 24/7, личный кабинет и Telegram-бот — бесплатно.",
  },
  {
    tier: 1,
    name: "Про",
