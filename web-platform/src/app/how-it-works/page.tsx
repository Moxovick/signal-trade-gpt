...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Сразу после привязки PO доступен Бесплатный уровень: 3 OTC-сигнала в день. От $20 — Базовый (10 сигналов, OTC + биржа). От $100 — Про (безлимит, все типы + аналитика).",
  },
  {
    n: "04",
    icon: Bot,
...
const TIERS = [
  ...
  },
  {
    ...
    name: "Про",
    deposit: "от $100",
    desc: "Депозит от $100 — безлимит сигналов. Все типы (OTC + биржа + Elite). Графики с RSI/MACD, углублённый разбор и аналитика.",
  },
];
      ...
      <main className="relative">
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold">3 уровня доступа</h2>
          </div>
